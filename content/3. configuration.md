...
We provide a special `/auth/login` endpoint that allows you to exchange a username/password for a `access_token`. You can then pass the access token in future requests.
